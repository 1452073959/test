    ...
    <div class="col-md-5">
        ...
        <form class="form-vertical" role="form" method="post" action="/posts">
            ...
            <div class="form-group">
                <input type="text" name="title" value="你好啊" class="form-control" placeholder="Title">
            </div>
            <div class="form-group">
                <textarea class="form-control" rows="5" name="body" class="form-control" placeholder="Content">hello !</textarea>
            </div>
            <div class="form-group">
